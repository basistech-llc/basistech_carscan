...
def get_secret(secret_arn):
    ...
    try:
        ...
        if 'SecretString' in get_secret_value_response:
            return secret_cache[secret_arn] := json.loads(get_secret_value_response['SecretString'])
...
def google_creds():
    return get_secret(os.environ['GOOGLE_SECRET_ARN'])

def brivo_creds():
    return get_secret(os.environ['BRIVO_SECRET_ARN'])
